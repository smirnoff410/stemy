package md531621648bdd7f47d0992da190cedae4c;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DesignLibrary.Helpers.AttachStateChangeListener, DesignLibrary_Tutorial, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AttachStateChangeListener.class, __md_methods);
	}
	...
	public AttachStateChangeListener ()
	{
		...
		if (getClass () == AttachStateChangeListener.class)
			mono.android.TypeManager.Activate ("DesignLibrary.Helpers.AttachStateChangeListener, DesignLibrary_Tutorial, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
